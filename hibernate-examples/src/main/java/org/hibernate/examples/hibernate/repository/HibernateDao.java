...
public interface HibernateDao {
    ...
    /**
     * 해당 수형의 엔티티 중 질의 {@link org.hibernate.criterion.DetachedCriteria}로 필터링된 엔티티들을 조회합니다.
     *
     * @param clazz  entity type
     * @param dc     질의 조건
     * @param orders ordering
    ...
    /**
     * 해당 수형의 엔티티 중 질의 {@link org.hibernate.criterion.DetachedCriteria}로 필터링된 엔티티 중 범위에 해당하는 엔티티만 조회합니다.
     *
     * @param clazz       entity type
     * @param dc          질의 조건
     * @param firstResult first result index (start from 0)
    ...
    /**
     * 해당 수헝을 {@link org.hibernate.criterion.Example} 로 질의를 수행합니다.
     *
     * @param clazz   entity type
